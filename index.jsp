			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
					...
					<ul class="nav hidden-xs" id="lg-menu">
                                            <li class="active"><div class="navrow" id="topic1"><i class="glyphicon glyphicon-list-alt topic-circle sports"></i> Sports</div></li>
						<li><div class="navrow" id="topic2"><i class="glyphicon glyphicon-list-alt topic-circle entertainment"></i> Entertainment</div></li>
						<li><div class="navrow" id="topic3"><i class="glyphicon glyphicon-list-alt topic-circle politics"></i> Politics</div></li>
						<li><div class="navrow" id="topic4"><i class="glyphicon glyphicon-list-alt topic-circle educational"></i> Education</div></li>
						<li><div class="navrow" id="topic5"><i class="glyphicon glyphicon-list-alt topic-circle technology"></i> Technology</div></li>
						<li><div class="navrow" id="topic6"><i class="glyphicon glyphicon-list-alt topic-circle travel"></i> Travel</div></li>
					</ul>
					<!-- tiny only nav-->
