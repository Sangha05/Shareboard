                                            ...
                                            <form id="register-form" action="signupVerify.jsp" method="post" role="form" style="display: none;">
                                                ...
                                                <div class="row">
                                                      ...
                                                      <div class="btn-group btn-group" data-toggle="buttons">
                                                        <label class="btn active">
                                                            <input type="checkbox" id="sports" value="1" name='interest' checked><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i><span> Sports</span>
                                                        </label>
                                                        <label class="btn">
                                                        ...
                                                        <label class="btn">
                                                          ...
                                                          <label class="btn active">
                                                              <input type="checkbox" id="education" value="4" name='interest' checked><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i><span> Education </span>
                                                        </label>
                                                        <label class="btn">
